...
$.tmUpload = function(options){
	...
	var settings = {
			flash_url : "../resource/swfupload/js/upload/swfupload.swf",
			...
			file_dialog_complete_handler : function(numFilesSelected, numFilesQueued){
				...
				this.setPostParams({"folderid":folderid});
				this.startUpload();
			},
...
$.tmUpload.defaults = {
	...
	btnId:"tmupload",//按钮
	btnImage: "../resource/swfupload/js/upload/btn_wj.jpg",//对应的上传图标
	btnWidth:100,//图标的宽度
	btnHeight:32,//图标的高度
 ...
 function tm_append_uploaditem(file){
	 ...
	 if(isEmpty(html)){
		 ...
		 "		<span class='fl bar_title'>二次开发上传组件</span></span>"+
	 ...
	 "	<div class='load_area'>"+
		 ...
		 "					<span class='loaded' style='display:none'><img src='../swfupload/js/upload/loading2.gif'/></span>"+
